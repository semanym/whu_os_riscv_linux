...
user/_getprocs:     file format elf64-littleriscv
...
int main(int argc, char *argv[])
{
  ...
  int count = getprocs();
   ...
   c:	34c080e7          	jalr	844(ra) # 354 <getprocs>
  10:	85aa                	mv	a1,a0
  printf("There are %d active processes.\n", count);
  12:	00000517          	auipc	a0,0x0
  16:	7ce50513          	addi	a0,a0,1998 # 7e0 <malloc+0xee>
  1a:	00000097          	auipc	ra,0x0
  1e:	61a080e7          	jalr	1562(ra) # 634 <printf>
  exit(0);
  22:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3a4:	46850513          	addi	a0,a0,1128 # 808 <digits>
 3a8:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 470:	39cb8b93          	addi	s7,s7,924 # 808 <digits>
 ...
 5b0:	25490913          	addi	s2,s2,596 # 800 <malloc+0x10e>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 7ca:	b76080e7          	jalr	-1162(ra) # 33c <sbrk>
  if(p == (char*)-1)
